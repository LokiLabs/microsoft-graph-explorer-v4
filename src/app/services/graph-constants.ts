...
export const DEFAULT_APPLICATION_SCOPES = 'https://graph.microsoft.com/.default openid profile offline_access';
export const DEFAULT_USER_SCOPES = 'openid profile offline_access';
