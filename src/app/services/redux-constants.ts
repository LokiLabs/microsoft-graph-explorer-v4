...
export const CHANGE_PERMISSIONS_MODE_SUCCESS = 'CHANGE_PERMISSIONS_MODE_SUCCESS';
export const CHANGE_PERMISSIONS_FAILURE = 'CHANGE_PERMISSIONS_FAILURE';
export const CLOSE_POP_UP_SUCCESS = 'CLOSE_POP_UP_SUCCESS';
export const PREPARE_NEXT_POP_UP_SUCCESS = 'PREPARE_NEXT_POP_UP_SUCCESS';